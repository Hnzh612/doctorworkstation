<template>
  <div v-if="this.$type == '管理员'">
    ...
    <el-table ref="singleTable" :data="tableData" highlight-current-row @current-change="handleCurrentChange"
      ...
      <el-table-column prop="sname" label="患者姓名" width="120" align="center">
      </el-table-column>
      <el-table-column prop="sphone" label="电话" width="130" align="center">
      </el-table-column>
      <el-table-column prop="scompany" label="性别" width="250" align="center">
      </el-table-column>
      <el-table-column prop="rname" label="年龄" width="120" align="center">
      </el-table-column>
      <el-table-column prop="rphone" label="血压" width="130" align="center">
      </el-table-column>
      <el-table-column prop="rcompany" label="血糖" width="250" align="center">
      </el-table-column>
